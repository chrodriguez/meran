...
nro_socio_temp=0;function modificarDatosDeUsuario(){objAH=new AjaxHelper(updateModificarDatosDeUsuario);objAH.url=URL_PREFIX+'/usuarios/reales/usuariosRealesDB.pl';objAH.debug=true;objAH.showOverlay=true;objAH.nro_socio=usuario.ID;nro_socio_temp=objAH.nro_socio;objAH.tipoAccion='MODIFICAR_USUARIO';objAH.sendToServer();}
