...
sub libreDeuda(){
	...
	$parrafo[3]=" validez de 10 dÌas corridos a partir de su fecha de emisiÛn.";
...
sub prestInterBiblio(){
	...
	$parrafo[2]=$director;
	$parrafo[3]="S/D";
	$parrafo[4]="          Tengo el agrado de dirigirme a Ud. a fin de solicitarle en car·cter de prÈstamo"; 
	...
	$parrafo[2]="DNI:".$dni;
	$parrafo[3]="DirecciÛn:".$borrewer->{'streetaddress'}.", ".&C4::Search::darCiudad($borrewer->{'city'});
	$parrafo[4]="TelÈfono:".$borrewer->{'phone'};
	$parrafo[5]="Correo electrÈnico:".$borrewer->{'emailaddress'};
	$parrafo[6]="";
...
@params:
	...
	$x, tama√±o de la sangria. A partir de donde se va a escribir en el renglon;
...
sub imprimirFirma(){
	...
	$pdf->addRawText("AclaraciÛn", 360,$pageheight - $y);
	return($pdf,$y);
}
...
sub imprimirTabla(){
	...
	$pdf->addRawText("TÌtulo", 255,$pageheight - ($y+15));
...
sub imprimirPiePag(){
	...
	$texto[3]="AtenciÛn: lunes a viernes, ".C4::Context->preference('open')." a ".C4::Context->preference('close');
