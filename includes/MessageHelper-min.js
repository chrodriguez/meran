function MessageHelper(){function fClearMessages(){$('#mensajes').css({opacity:0,"filter":"alpha(opacity=0)"});$('#mensajes').hide();$('#mensajes').html('');};this.clearMessages=fClearMessages;}
