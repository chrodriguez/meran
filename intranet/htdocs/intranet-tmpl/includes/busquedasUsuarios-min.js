...
function updateInfoUsuarios(responseText){$('#marco_contenido_datos').html(responseText);var idArray=[];var classes=[];idArray[0]='socio';classes[0]='nomCompleto';classes[1]='documento';classes[2]='legajo';classes[3]='tarjetaId';busqueda=jQuery.trim($('#socio').val());scrollTo('marco_contenido_datos');}
