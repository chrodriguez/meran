...
function updateInfoUsuarios(responseText){$('#result_usuarios').html(responseText);zebra('datos_tabla');var idArray=[];var classes=[];idArray[0]='socio';classes[0]='nomCompleto';classes[1]='documento';classes[2]='legajo';classes[3]='tarjetaId';busqueda=jQuery.trim($('#socio').val());$("#resultBusqueda").slideUp("slow");scrollTo('result');}
