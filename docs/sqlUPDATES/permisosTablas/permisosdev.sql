...
GRANT ALL on  ref_dptos_partidos                 to dev@localhost; 
...
GRANT ALL on  ref_provincias                     to dev@localhost; 
...
GRANT ALL on  sessionqueries                     to dev@localhost; 
GRANT ALL on  sist_sesion                        to dev@localhost; 
GRANT ALL on  unavailable                        to dev@localhost; 
GRANT ALL on  uploadedmarc                       to dev@localhost; 
