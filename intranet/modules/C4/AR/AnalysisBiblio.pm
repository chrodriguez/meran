...
{
	   my ($analyticalnumber,$analyticaltitle,$analyticalunititle,$subjectheadings,$classification,$bibnum,$analyticalauthor,$bibnumitems,$parts,$time)=@_;
	   ...
	   my $sth=$dbh->prepare("UPDATE biblioanalysis  SET analyticaltitle=?, biblionumber=?, analyticalunititle=?, biblioitemnumber=?, parts=?, classification=?  WHERE analyticalnumber=? ");
           $sth->execute($analyticaltitle,$bibnum,$analyticalunititle,$bibnumitems,$parts,$classification,$analyticalnumber);
	  $sth->finish;
...
{
 my ($analyticaltitle,$analyticalunititle,$subjectheadings,$classification,$bibnum,$analyticalauthor,$bibnumitems,$parts)=@_;
 ...
 my $query ="INSERT INTO `biblioanalysis` 
        ( `analyticaltitle` , `biblionumber` , `analyticalunititle` , `biblioitemnumber` , `parts`,`classification` , `timestamp`,`analyticalnumber`) 
        VALUES (?, ?, ?, ?, ?,?, NOW( ),?);";
 my $sth=$dbh->prepare($query);
 $sth->execute($analyticaltitle,$bibnum,$analyticalunititle,$bibnumitems,$parts,$classification,$analyticalnumber);
