...
sub prestInterBiblio(){
	...
	$parrafo[5]="interbibliotecario los siguientes �tems:";
	...
	$parrafo[2]="DNI:".$dni;
	$parrafo[3]="Direcci�n:".$borrewer->{'streetaddress'}.", ".&C4::Search::darCiudad($borrewer->{'city'});
...
sub imprimirTabla(){
	...
	$pdf->addRawText("T�tulo", 255,$pageheight - ($y+15));
