...
my $tipo=$input->param('tipo'); # Tipo de reserva
my @resultsdata= reservas($branch,$orden,$ini,$cantR,$tipo);
my $cant=cantidadReservas($branch,$tipo);
