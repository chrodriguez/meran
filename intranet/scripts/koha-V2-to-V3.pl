...
#---------------------------------------NIVEL1---------------------------------------#
	...
	#########################################################################
	my($error,$codMsg);
	($id1,$error,$codMsg)=&C4::AR::Nivel1::saveNivel1($autor,\@ids1);
...
#---------------------------------------NIVEL2---------------------------------------#
	...
	($id2,$tipoDocN2,$error,$codMsg)=&C4::AR::Nivel2::saveNivel2($id1,\@ids2);
...
#---------------------------------------NIVEL3---------------------------------------#	
	...
	($error,$codMsg)=&C4::AR::Nivel3::saveNivel3($id1,$id2,$item->{'barcode'},1,$tipoDocN2,\@ids3);
...
(2, '245', 'b', 'ALL', 'Título informativo', 'text', 0, 1, 0, 2, 1),
...
(8, '900', 'b', 'ALL', 'Nivel Bibliográfico', 'combo', 1, 2, 0, 1, 1),
(9, '245', 'h', 'ALL', 'Soporte', 'combo', 1, 2, 0, 2, 1),
(10, '250', 'a', 'ALL', 'Número de Edición', 'text', 0, 2, 0, 3, 1),
(11, '260', 'a', 'ALL', 'Lugar de publicación', 'text', 0, 2, 0, 4, 1),
(12, '260', 'b', 'ALL', 'Editor', 'texa2', 0, 2, 0, 5, 1),
(13, '260', 'c', 'ALL', 'Año de Edición', 'text', 0, 2, 0, 6, 1),
(14, '300', 'a', 'ALL', 'Descripción Física', 'text', 0, 2, 0, 7, 1),
(15, '300', 'c', 'ALL', 'Tamaño', 'text', 0, 2, 0, 8, 1),
...
(20, '740', 'a', 'ALL', 'Descripción del volumen', 'text', 0, 2, 0, 14, 1),
(21, '043', 'c', 'ALL', 'País', 'combo', 1, 2, 0, 15, 1),
(22, '041', 'h', 'ALL', 'Idioma', 'combo', 1, 2, 0, 16, 1),
(23, '500', 'a', 'ALL', 'Notas', 'texta', 0, 2, 0, 18, 1),
(24, '995', 'c', 'ALL', 'Unidad de Información', 'combo', 1, 3, 1, 1, 1),
(25, '995', 'd', 'ALL', 'Unidad de Información de Origen', 'combo', 1, 3, 1, 2, 1),
(26, '995', 't', 'ALL', 'Signatura Topográfica', 'text', 0, 3, 0, 3, 1),
...
(0, 0, '020', 'c', 'Términos de disponibilidad', 'Términos de disponibilidad', 0, 0, NULL, -1, NULL, NULL, ''),
(0, 0, '020', 'z', 'ISBN Inválido/cancelado', 'ISBN Invalido/cancelado', 1, 0, NULL, -1, NULL, NULL, ''),
...
(2, 0, '041', 'a', 'Código de Idioma para texto o pista de sonido o título separado', 'Código de Idioma para texto o pista de sonido o título separado', 0, 0, 'biblioitems.idLanguage', 0, 'languages', NULL, ''),
...
(2, 0, '041', 'h', 'Código de idioma de la versión original y/o traducciones intermedias del texto', 'Código de idioma de la versión original y/o traducciones intermedias del texto', 1, 0, NULL, 0, NULL, NULL, ''),
...
(2, 0, '043', 'a', 'Código de área geográfica (R)', 'Código de área geográfica (R)', 1, 0, NULL, 0, NULL, NULL, ''),
(2, 0, '043', 'c', 'Código ISO (R)', 'Código ISO (R)', 1, 0, 'biblioitems.idCountry', 0, 'countries', NULL, ''),
...
(1, 0, '072', '2', 'Fuente del código', 'Fuente del código', 0, 0, NULL, 0, NULL, NULL, ''),
...
(1, 0, '072', 'a', 'Código de categoría temática', 'Código de categoría temática', 0, 0, NULL, 0, NULL, NULL, ''),
(1, 0, '072', 'x', 'Código de subdivisión de categoría temática', 'Código de subdivisión de categoría temática', 1, 0, NULL, 0, NULL, NULL, ''),
...
(1, 0, '080', '2', 'Identificador de la edición', 'Identificador de la edición', 0, 0, NULL, 0, NULL, NULL, ''),
...
(1, 0, '080', 'a', 'Número de Clasificación Decimal Universal', 'Número de Clasificación Decimal Universal', 0, 0, 'biblio.seriestitle', 0, NULL, NULL, ''),
(1, 0, '080', 'b', 'Número del Item', 'Número del Item', 0, 0, NULL, 0, NULL, NULL, ''),
(1, 0, '080', 'x', 'Subdivisión auxiliar comúón (R)', 'Subdivisión auxiliar común (R)', 1, 0, NULL, 0, NULL, NULL, ''),
(1, 0, '082', '2', 'No. de la edición', 'No. de la edición', 0, 0, NULL, 0, NULL, NULL, ''),
...
(1, 0, '082', 'a', 'Número de Clasificación Decimal Dewey (R)', 'Número de Clasificación Decimal Dewey (R)', 1, 0, NULL, 0, NULL, NULL, ''),
(1, 0, '082', 'b', 'No. del Item', 'No. del Item', 1, 0, NULL, 0, NULL, NULL, ''),
(1, 0, '084', '2', 'Fuente del número', 'Fuente del número', 0, 0, NULL, 0, NULL, NULL, ''),
...
(1, 0, '084', 'a', 'Otro Número de Clasificación (R)', 'Otro Número de Clasificación (R)', 1, 0, NULL, 0, NULL, NULL, ''),
(1, 0, '084', 'b', 'Número del Item', 'Número del Item', 0, 0, NULL, -1, NULL, NULL, ''),
(0, 0, '086', '2', 'Fuente del número', 'Fuente del número', 0, 0, NULL, -1, NULL, NULL, ''),
...
(0, 0, '086', 'a', 'Número de Clasificación para Documentos Gubernamentales', 'Número de Clasificación para Documentos Gubernamentales', 0, 0, NULL, -1, NULL, NULL, ''),
(0, 0, '086', 'z', 'Número de clasificación cancelado/inválido (R)', 'Número de clasificación cancelado/inválido (R)', 1, 0, NULL, -1, NULL, NULL, ''),
...
(0, 0, '100', '4', 'Código de relación', 'Código de relación', 1, 0, NULL, 1, NULL, NULL, ''),
...
(1, 0, '100', 'b', 'Numeración', 'Numeración', 0, 0, NULL, 1, NULL, NULL, ''),
(1, 0, '100', 'c', 'Títulos y otras palabras asociadas con el nombre', 'Títulos y otras palabras asociadas con el nombre', 1, 0, NULL, 1, NULL, NULL, ''),
(1, 0, '100', 'd', 'Fechas asociadas con el nombre', 'Fechas asociadas con el nombre', 0, 0, NULL, 1, NULL, NULL, ''),
(1, 0, '100', 'e', 'Término de relación', 'Término de relación', 1, 0, NULL, 1, NULL, NULL, ''),
...
(1, 0, '100', 'u', 'Afiliación', 'Afiliación', 0, 0, NULL, 1, NULL, NULL, ''),
(1, 0, '110', '4', 'Código de relación', 'Código de relación', 1, 0, NULL, 1, NULL, NULL, ''),
...
(1, 0, '110', 'a', 'Nombre de la institución, jurisdicción como entrada principal', 'Nombre de la institución, jurisdicción como entrada principal', 0, 0, NULL, 1, NULL, NULL, ''),
...
(1, 0, '110', 'e', 'Término de relación', 'Término de relación', 1, 0, NULL, 1, NULL, NULL, ''),
...
(1, 0, '110', 'u', 'Afiliación', 'Afiliación', 0, 0, NULL, 1, NULL, NULL, ''),
(1, 0, '111', '4', 'Código de relación', 'Código de relación', 1, 0, NULL, 1, NULL, NULL, ''),
...
(1, 0, '111', 'a', 'Nombre de la reunión como entrada principal', 'Nombre de la reunión como entrada principal', 0, 0, NULL, 1, NULL, NULL, ''),
(0, 0, '111', 'b', 'Number  (BK CF MP MU SE VM MX) [OBSOLETE]', 'Number  (BK CF MP MU SE VM MX) [OBSOLETE]', 1, 0, NULL, -1, NULL, NULL, ''),
(1, 0, '111', 'c', 'Localización de la reunión', 'Localización de la reunión', 0, 0, NULL, 1, NULL, NULL, ''),
(1, 0, '111', 'd', 'Fecha de la reunión', 'Fecha de la reunión', 0, 0, NULL, 1, NULL, NULL, ''),
...
(0, 0, '111', 'n', 'Número de la parte/sección/reunión', 'Número de la parte/sección/reunión', 1, 0, NULL, 1, NULL, NULL, ''),
...
(1, 0, '111', 'u', 'Afiliación', 'Afiliación', 0, 0, NULL, 1, NULL, NULL, ''),
...
(1, 0, '210', 'a', 'Título abreviado', 'Título abreviado', 0, 0, NULL, 2, NULL, NULL, ''),
(0, 0, '210', 'b', 'Información calificadora', 'Información calificadora', 0, 0, NULL, 2, NULL, NULL, ''),
...
(1, 0, '222', 'a', 'Título clave', 'Título clave', 0, 0, NULL, 2, NULL, NULL, ''),
...
(1, 0, '240', 'a', 'Título Uniforme', 'Título Uniforme', 0, 0, NULL, 2, NULL, NULL, ''),
...
(0, 0, '240', 'g', 'Información miscelánea', 'Información miscelánea', 0, 0, NULL, 2, NULL, NULL, ''),
...
(0, 0, '240', 'n', 'Número de la parte/sección/reunión', 'Número de la parte/sección/reunión', 1, 0, NULL, 2, NULL, NULL, ''),
(0, 0, '240', 'o', 'Arranged statement for music', 'Arranged statement for music', 0, 0, NULL, -1, NULL, NULL, ''),
(0, 0, '240', 'p', 'Nombre de la parte/sección', 'Nombre de la parte/sección', 1, 0, NULL, 2, NULL, NULL, ''),
...
(1, 0, '242', 'a', 'Título', 'Título', 0, 0, NULL, 2, NULL, NULL, ''),
(1, 0, '242', 'b', 'Resto del título', 'Resto del título', 0, 0, NULL, 2, NULL, NULL, ''),
(1, 0, '242', 'c', 'Mención de responsabilidad', 'Mención de responsabilidad', 0, 0, NULL, 2, NULL, NULL, ''),
...
(0, 0, '242', 'n', 'Número de la parte/sección del trabajo', 'Número de la parte/sección del trabajo', 1, 0, NULL, 2, NULL, NULL, ''),
(0, 0, '242', 'p', 'Nombre de la parte/sección del trabajo', 'Nombre de la parte/sección del trabajo', 1, 0, NULL, 2, NULL, NULL, ''),
(1, 0, '242', 'y', 'Código de idioma del título traducido', 'Código de idioma del título traducido', 0, 0, NULL, 2, NULL, NULL, ''),
...
(1, 1, '245', 'a', 'Título', 'Título', 0, 0, 'biblio.title', 2, NULL, NULL, ''),
(1, 0, '245', 'b', 'Resto del título', 'Resto del título', 0, 0, 'biblio.unititle', 2, NULL, NULL, ''),
(1, 0, '245', 'c', 'Mención de responsabilidad', 'Mención de responsabilidad', 0, 0, NULL, 2, NULL, NULL, ''),
...
(1, 0, '245', 'n', 'Número de la parte/sección de la obra', 'Número de la parte/sección de la obra', 1, 0, NULL, 2, NULL, NULL, ''),
(1, 0, '245', 'p', 'Nombre de la parte/sección de la obra', 'Nombre de la parte/sección de la obra', 1, 0, NULL, 2, NULL, NULL, ''),
...
(1, 0, '246', 'a', 'Título propiamente dicho/Título corto', 'Título propiamente dicho/Título corto', 0, 0, 'bibliosubtitle.subtitle', 2, NULL, NULL, ''),
(1, 0, '246', 'b', 'Resto del título', 'Resto del título', 0, 0, NULL, 2, NULL, NULL, ''),
...
(1, 0, '246', 'f', 'Designación de volumen y número y/o fecha del trabajo', 'Designación de volumen y número y/o fecha del trabajo', 0, 0, NULL, 2, NULL, NULL, ''),
(1, 0, '246', 'g', 'Información miscelánea', 'Información miscelánea', 0, 0, NULL, 2, NULL, NULL, ''),
(1, 0, '246', 'h', 'Medio', 'Medio', 0, 0, NULL, 2, NULL, NULL, ''),
(1, 0, '246', 'i', 'Texto a desplegar', 'Texto a desplegar', 0, 0, NULL, 2, NULL, NULL, ''),
(0, 0, '246', 'n', 'Número de parte/sección de la obra', 'Número de parte/sección de la obra', 1, 0, NULL, 2, NULL, NULL, ''),
(0, 0, '246', 'p', 'Nombre de parte/sección de la obra', 'Nombre de parte/sección de la obra', 1, 0, NULL, 2, NULL, NULL, ''),
...
(2, 0, '250', 'a', 'Mención de edición', 'Mención de edición', 0, 0, 'biblioitems.number', 2, NULL, NULL, ''),
(2, 0, '250', 'b', 'Resto de la mención de edición', 'Resto de la mención de edición', 0, 0, NULL, 2, NULL, NULL, ''),
...
(2, 0, '260', 'a', 'Lugar de publicación, distribución, etc.', 'Lugar de publicación, distribución, etc.', 1, 0, 'biblioitems.place', 2, NULL, NULL, ''),
...
(2, 0, '260', 'c', 'Fecha de publicación, distribución, etc.', 'Fecha de publicación, distribución, etc.', 1, 0, 'biblioitems.publicationyear', 2, NULL, NULL, ''),
...
(2, 0, '300', 'a', 'Extensión', 'Extensión', 1, 0, 'biblioitems.pages', 3, '', '', ''),
(2, 0, '300', 'b', 'Otros detalles físicos', 'Otros detalles físicos', 0, 0, 'biblioitems.illus', 3, '', '', ''),
(2, 0, '300', 'c', 'Dimensiones', 'Dimensiones', 1, 0, 'biblioitems.size', 3, '', '', ''),
(2, 0, '300', 'e', 'Material acompañante', 'Material acompañante', 0, 0, NULL, 3, '', '', ''),
...
(2, 0, '310', 'a', 'Frecuencia actual de la publicación', 'Frecuencia actual de la publicación', 0, 0, NULL, 3, NULL, NULL, ''),
(2, 0, '310', 'b', 'Fecha de la frecuencia actual de la publicación', 'Fecha de la frecuencia actual de la publicación', 0, 0, NULL, 3, NULL, NULL, ''),
...
(2, 0, '362', 'a', 'Fecha de publicación y/o designación secuencial', 'Fecha de publicación y/o designación secuencial', 0, 0, NULL, 3, NULL, NULL, ''),
(2, 0, '362', 'z', 'Fuente de la información', 'Fuente de la información', 0, 0, NULL, 3, NULL, NULL, ''),
...
(2, 0, '440', 'a', 'Título', 'Título', 0, 0, 'biblioitems.seriestitle', 4, NULL, NULL, ''),
(2, 0, '440', 'n', 'Número de la parte/sección de una obra', 'Número de la parte/sección de una obra', 1, 0, NULL, 4, NULL, NULL, ''),
(2, 0, '440', 'p', 'Nombre de la parte/sección', 'Nombre de la parte/sección', 1, 0, NULL, 4, NULL, NULL, ''),
(2, 0, '440', 'v', 'Número de volumen/designación secuencial', 'Número de volumen/designación secuencial', 0, 0, NULL, 4, NULL, NULL, ''),
...
(2, 0, '504', 'a', 'Nota de Bibliografía, etc.', 'Nota de Bibliografía, etc.', 0, 0, NULL, 5, NULL, NULL, ''),
(2, 0, '504', 'b', 'Número de referencias', 'Número de referencias', 0, 0, NULL, 5, NULL, NULL, ''),
...
(1, 0, '534', 'b', 'Mención de edición del original', 'Mención de edición del original', 0, 0, NULL, 5, NULL, NULL, ''),
(1, 0, '534', 'c', 'Publicación, distribución, etc. del original', 'Publicación, distribución, etc. del original', 0, 0, NULL, 5, NULL, NULL, ''),
(1, 0, '534', 'e', 'Descripción física, etc. del original', 'Descripción física, etc. del original', 0, 0, NULL, 5, NULL, NULL, ''),
...
(0, 0, '534', 't', 'Mención de título del original', 'Mención de título del original', 0, 0, NULL, 5, NULL, NULL, ''),
...
(2, 0, '546', 'b', 'Información sobre códigos o alfabetos', 'Información sobre códigos o alfabetos', 1, 0, NULL, 5, NULL, NULL, ''),
...
(1, 0, '600', '2', 'Fuente del encabezamiento o término', 'Fuente del encabezamiento o término', 0, 0, NULL, 6, NULL, NULL, ''),
(0, 0, '600', '3', 'Materials specified', 'Materials specified', 0, 0, NULL, -1, NULL, NULL, ''),
(0, 0, '600', '4', 'Código de relación', 'Código de relación', 1, 0, NULL, 6, NULL, NULL, ''),
...
(1, 0, '600', 'b', 'Numeración', 'Numeración', 0, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '600', 'c', 'Títulos y otras palabras asociadas con el nombre', 'Títulos y otras palabras asociadas con el nombre', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '600', 'd', 'Fechas asociadas con el nombre', 'Fechas asociadas con el nombre', 0, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '600', 'e', 'Término de relación', 'Término de relación', 1, 0, NULL, 6, NULL, NULL, ''),
...
(1, 0, '600', 't', 'Título del trabajo', 'Título del trabajo', 0, 0, NULL, 6, NULL, NULL, ''),
(0, 0, '600', 'u', 'Afiliación', 'Afiliación', 0, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '600', 'v', 'Subdivisión de forma', 'Subdivisión de forma', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '600', 'x', 'Subdivisión general', 'Subdivisión general', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '600', 'y', 'Subdivisión cronológica', 'Subdivisión cronológica', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '600', 'z', 'Subdivisión geográfica', 'Subdivisión geográfica', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '610', '2', 'Fuente del encabezamiento o término', 'Fuente del encabezamiento o término', 0, 0, NULL, 6, NULL, NULL, ''),
(0, 0, '610', '3', 'Materials specified', 'Materials specified', 0, 0, NULL, -1, NULL, NULL, ''),
(1, 0, '610', '4', 'Código de relación', 'Código de relación', 1, 0, NULL, 6, NULL, NULL, ''),
...
(1, 0, '610', 'a', 'Nombre corporativo o de jurisdicción como entrada', 'Nombre corporativo o de jurisdicción como entrada', 0, 0, NULL, 6, NULL, NULL, ''),
...
(1, 0, '610', 'e', 'Relación', 'Relación', 1, 0, NULL, 6, NULL, NULL, ''),
...
(1, 0, '610', 't', 'Título del trabajo', 'Título del trabajo', 0, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '610', 'u', 'Afiliación', 'Afiliación', 0, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '610', 'v', 'Subdivisión de forma', 'Subdivisión de forma', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '610', 'x', 'Subdivisión general', 'Subdivisión general', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '610', 'y', 'Subdivisión cronológica', 'Subdivisión cronológica', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '610', 'z', 'Subdivisión geográfica', 'Subdivisión geográfica', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '611', '2', 'Fuente del encabezamiento o término', 'Fuente del encabezamiento o término', 0, 0, NULL, 6, NULL, NULL, ''),
(0, 0, '611', '3', 'Materials specified', 'Materials specified', 0, 0, NULL, -1, NULL, NULL, ''),
(0, 0, '611', '4', 'Código de relator', 'Código de relator', 1, 0, NULL, 6, NULL, NULL, ''),
...
(1, 0, '611', 'a', 'Nombre de la reunión o jurisdicción como entrada', 'Nombre de la reunión o jurisdicción como entrada', 0, 0, NULL, 6, NULL, NULL, ''),
(0, 0, '611', 'b', 'Number  (BK CF MP MU SE VM MX)  [OBSOLETE]', 'Number  (BK CF MP MU SE VM MX)  [OBSOLETE]', 1, 0, NULL, -1, NULL, NULL, ''),
(1, 0, '611', 'c', 'Lugar de la reunión', 'Lugar de la reunión', 0, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '611', 'd', 'Fecha de la reunión', 'Fecha de la reunión', 0, 0, NULL, 6, NULL, NULL, ''),
...
(1, 0, '611', 'n', 'Número de parte/sección/reunión', 'Número de parte/sección/reunión', 1, 0, NULL, 6, NULL, NULL, ''),
...
(0, 0, '611', 't', 'Título del trabajo', 'Título del trabajo', 0, 0, NULL, 6, NULL, NULL, ''),
(0, 0, '611', 'u', 'Afiliación', 'Afiliación', 0, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '611', 'v', 'Subdivisión de forma', 'Subdivisión de forma', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '611', 'x', 'Subdivisión general', 'Subdivisión general', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '611', 'y', 'Subdivisión cronológica', 'Subdivisión cronológica', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '611', 'z', 'Subdivisión geográfica', 'Subdivisión geográfica', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '630', '2', 'Fuente del encabezamiento o término', 'Fuente del encabezamiento o término', 0, 0, NULL, 6, NULL, NULL, ''),
...
(1, 0, '630', 'a', 'Título Uniforme', 'Título Uniforme', 0, 0, NULL, 6, NULL, NULL, ''),
...
(0, 0, '630', 'n', 'Número de la parte/sección/reunión', 'Número de la parte/sección/reunión', 1, 0, NULL, 6, NULL, NULL, ''),
(0, 0, '630', 'o', 'Arranged statement for music', 'Arranged statement for music', 0, 0, NULL, -1, NULL, NULL, ''),
(0, 0, '630', 'p', 'Nombre de la parte/sección', 'Nombre de la parte/sección', 1, 0, NULL, 6, NULL, NULL, ''),
...
(1, 0, '630', 'v', 'Subdivisión de forma', 'Subdivisión de forma', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '630', 'x', 'Subdivisión general', 'Subdivisión general', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '630', 'y', 'Subdivisión cronológica', 'Subdivisión cronológica', 1, 0, NULL, 6, NULL, NULL, ''),
(0, 0, '630', 'z', 'Subdivisión geografica', 'Subdivisión geográfica', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '650', '2', 'Fuente del encabezamiento o término', 'Fuente del encabezamiento o término', 0, 0, NULL, 6, NULL, NULL, ''),
...
(1, 0, '650', 'a', 'Tópico o nombre geográfico', 'Tópico o nombre geográfico', 0, 0, 'bibliosubject.subject', 6, NULL, NULL, ''),
...
(1, 0, '650', 'e', 'Relación', 'Relación', 0, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '650', 'v', 'Subdivisión de forma', 'Subdivisión de forma', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '650', 'x', 'Subdivisión general', 'Subdivisión general', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '650', 'y', 'Subdivisión cronológica', 'Subdivisión cronológica', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '650', 'z', 'Subdivisión Geográfica', 'Subdivisión Geográfica', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '651', '2', 'Fuente del encabezamiento o término', 'Fuente del encabezamiento o término', 0, 0, NULL, 6, NULL, NULL, ''),
...
(1, 0, '651', 'a', 'Nombre geográfico', 'Nombre geográfico', 0, 0, NULL, 6, NULL, NULL, ''),
...
(1, 0, '651', 'v', 'Subdivisión de forma', 'Subdivisión de forma', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '651', 'x', 'Subdivisión general', 'Subdivisión general', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '651', 'y', 'Subdivisión cronológica', 'Subdivisión cronológica', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '651', 'z', 'Subdivisión geográfica', 'Subdivisión geográfica', 1, 0, NULL, 6, NULL, NULL, ''),
...
(1, 0, '653', 'a', 'Término no controlado', 'Término no controlado', 1, 0, NULL, 6, NULL, NULL, ''),
...
(1, 0, '655', '2', 'Fuente del encabezamiento o término', 'Fuente del encabezamiento o término', 0, 0, NULL, 6, NULL, NULL, ''),
...
(1, 0, '655', 'v', 'Subdivisión de forma', 'Subdivisión de forma', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '655', 'x', 'Subdivisión general', 'Subdivisión general', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '655', 'y', 'Subdivisión cronológic', 'Subdivisión cronológic', 1, 0, NULL, 6, NULL, NULL, ''),
(1, 0, '655', 'z', 'Subdivisión geográfica', 'Subdivisión geográfica', 1, 0, NULL, 6, NULL, NULL, ''),
...
(0, 0, '700', '4', 'Código de relación', 'Código de relación', 1, 0, NULL, 7, NULL, NULL, ''),
...
(1, 0, '700', 'b', 'Numeración', 'Numeración', 0, 0, NULL, 7, NULL, NULL, ''),
(1, 0, '700', 'c', 'Títulos y otras palabras asociadas con el nombre', 'Títulos y otras palabras asociadas con el nombre', 1, 0, NULL, 7, NULL, NULL, ''),
(1, 0, '700', 'd', 'Fechas asociadas con el nombre', 'Fechas asociadas con el nombre', 0, 0, NULL, 7, NULL, NULL, ''),
(1, 0, '700', 'e', 'Término de relación', 'Término de relación', 1, 0, NULL, 7, NULL, NULL, ''),
...
(1, 0, '700', 'u', 'Afiliación', 'Afiliación', 0, 0, NULL, 7, NULL, NULL, ''),
...
(0, 0, '710', '4', 'Código de relación', 'Código de relación', 1, 0, NULL, 7, NULL, NULL, ''),
...
(1, 0, '710', 'a', 'Nombre corporativo o de jurisdicción como entrada', 'Nombre corporativo o de jurisdicción como entrada', 0, 0, NULL, 7, NULL, NULL, ''),
...
(1, 0, '710', 'e', 'Relación', 'Relación', 1, 0, NULL, 7, NULL, NULL, ''),
...
(0, 0, '710', 't', 'Título del trabajo', 'Título del trabajo', 0, 0, NULL, 7, NULL, NULL, ''),
(0, 0, '710', 'u', 'Afiliación', 'Afiliación', 0, 0, NULL, 7, NULL, NULL, ''),
...
(0, 0, '711', '4', 'Código de relación', 'Código de relación', 1, 0, NULL, 7, NULL, NULL, ''),
...
(1, 0, '711', 'a', 'Nombre de la reunión o de jurisdicción como entrada', 'Nombre de la reunión o de jurisdicción como entrada', 0, 0, NULL, 7, NULL, NULL, ''),
(0, 0, '711', 'b', 'Number  (BK CF MP MU SE VM MX)  [OBSOLETE]', 'Number  (BK CF MP MU SE VM MX)  [OBSOLETE]', 1, 0, NULL, -1, NULL, NULL, ''),
(1, 0, '711', 'c', 'Localización de la reunión', 'Localización de la reunión', 0, 0, NULL, 7, NULL, NULL, ''),
(1, 0, '711', 'd', 'Fecha de la reunión o firma del tratado', 'Fecha de la reunión o firma del tratado', 0, 0, NULL, 7, NULL, NULL, ''),
...
(0, 0, '711', 'n', 'Número de la parte/sección del trabajo', 'Número de la parte/sección del trabajo', 1, 0, NULL, 7, NULL, NULL, ''),
...
(0, 0, '711', 't', 'Título del trabajo', 'Título del trabajo', 0, 0, NULL, 7, NULL, NULL, ''),
(0, 0, '711', 'u', 'Afiliación', 'Afiliación', 0, 0, NULL, 7, NULL, NULL, ''),
...
(1, 0, '720', '4', 'Código de la relación', 'Código de la relación', 1, 0, NULL, 7, NULL, NULL, ''),
...
(1, 0, '720', 'e', 'Relación', 'Relación', 1, 0, NULL, 7, NULL, NULL, ''),
...
(1, 0, '730', 'a', 'Título uniforme', 'Título uniforme', 0, 0, NULL, 7, NULL, NULL, ''),
...
(0, 0, '730', 'n', 'Número de la parte/sección del trabajo', 'Número de la parte/sección del trabajo', 1, 0, NULL, 7, NULL, NULL, ''),
(0, 0, '730', 'o', 'Arranged statement for music', 'Arranged statement for music', 0, 0, NULL, -1, NULL, NULL, ''),
(0, 0, '730', 'p', 'Nombre de una parte/sección del trabajo', 'Nombre de una parte/sección del trabajo', 1, 0, NULL, 7, NULL, NULL, ''),
...
(2, 0, '740', 'a', 'Título', 'Título', 0, 0, 'biblioitems.volumeddesc', 7, NULL, NULL, ''),
(0, 0, '740', 'h', 'Medium', 'Medium', 0, 0, NULL, -1, NULL, NULL, ''),
(2, 0, '740', 'n', 'Número de parte', 'Número de parte', 1, 0, 'biblioitems.volume', 7, NULL, NULL, ''),
...
(1, 0, '752', 'a', 'País', 'País', 0, 0, NULL, 7, NULL, NULL, ''),
(1, 0, '752', 'b', 'Estado, provincia, territorio', 'Estado, provincia, territorio', 0, 0, NULL, 7, NULL, NULL, ''),
(1, 0, '752', 'c', 'País, región, Area de islas', 'País, región, área de islas', 0, 0, NULL, 7, NULL, NULL, ''),
...
(2, 0, '760', 'b', 'Edición', 'Edición', 0, 0, NULL, 7, NULL, NULL, ''), 
(0, 0, '760', 'c', 'Qualifying information', 'Qualifying information', 0, 0, NULL, -1, NULL, NULL, ''),
(2, 0, '760', 'd', 'Lugar, editorial y fecha de publicación', 'Lugar, editorial y fecha de publicación', 0, 0, NULL, 7, NULL, NULL, ''),
(2, 0, '760', 'g', 'Información sobre relaciones', 'Información sobre relaciones', 1, 0, NULL, 7, NULL, NULL, ''),
(2, 0, '760', 'h', 'Descripción fisica', 'Descripción fisica', 0, 0, NULL, 7, NULL, NULL, ''),
...
(2, 0, '760', 'o', 'Otro ítem identificador', 'Otro ítem identificador', 1, 0, NULL, 7, NULL, NULL, ''),
...
(2, 0, '760', 't', 'Título', 'Título', 0, 0, NULL, 7, NULL, NULL, ''),
(2, 0, '760', 'w', 'Número de Control del Registro', 'Número de Control del Registro', 1, 0, NULL, 7, NULL, NULL, ''),
...
(2, 0, '762', 'b', 'Edición', 'Edición', 0, 0, NULL, 7, NULL, NULL, ''),
(0, 0, '762', 'c', 'Qualifying information', 'Qualifying information', 0, 0, NULL, -1, NULL, NULL, ''),
(2, 0, '762', 'd', 'Lugar, editorial y fecha de publicación', 'Lugar, editorial y fecha de publicación', 0, 0, NULL, 7, NULL, NULL, ''),
(2, 0, '762', 'g', 'Información sobre relaciones', 'Información sobre relaciones', 1, 0, NULL, 7, NULL, NULL, ''),
(2, 0, '762', 'h', 'Descripción física', 'Descripción física', 0, 0, NULL, 7, NULL, NULL, ''),
...
(2, 0, '762', 'o', 'Otro ítem identificador', 'Otro ítem identificador', 1, 0, NULL, 7, NULL, NULL, ''),
...
(0, 0, '762', 't', 'Título', 'Título', 0, 0, NULL, 7, NULL, NULL, ''),
(0, 0, '762', 'w', 'Número de Control del Registro', 'Número de Control del Registro', 1, 0, NULL, 7, NULL, NULL, ''),
...
(2, 0, '765', 'b', 'Edición', 'Edición', 0, 0, NULL, 7, NULL, NULL, ''),
(0, 0, '765', 'c', 'Qualifying information', 'Qualifying information', 0, 0, NULL, -1, NULL, NULL, ''),
(2, 0, '765', 'd', 'Lugar, editorial y fecha de publicación', 'Lugar, editorial y fecha de publicación', 0, 0, NULL, 7, NULL, NULL, ''),
(2, 0, '765', 'g', 'Información sobre relaciones', 'Información sobre relaciones', 1, 0, NULL, 7, NULL, NULL, ''),
(2, 0, '765', 'h', 'Descripción fisica', 'Descripción fisica', 0, 0, NULL, 7, NULL, NULL, ''),
...
(2, 0, '765', 'o', 'Otro ítem identificador', 'Otro ítem identificador', 1, 0, NULL, 7, NULL, NULL, ''),
...
(2, 0, '765', 't', 'Título', 'Título', 0, 0, NULL, 7, NULL, NULL, ''),
(0, 0, '765', 'u', 'Standard Technical Report Number', 'Standard Technical Report Number', 0, 0, NULL, -1, NULL, NULL, ''),
(2, 0, '765', 'w', 'Número de Control del Registro', 'Número de Control del Registro', 1, 0, NULL, 7, NULL, NULL, ''),
...
(2, 0, '770', 'b', 'Edición', 'Edición', 0, 0, NULL, 7, NULL, NULL, ''),
(0, 0, '770', 'c', 'Qualifying information', 'Qualifying information', 0, 0, NULL, -1, NULL, NULL, ''),
(2, 0, '770', 'd', 'Lugar, editorial y fecha de publicación', 'Lugar, editorial y fecha de publicación', 0, 0, NULL, 7, NULL, NULL, ''),
(2, 0, '770', 'g', 'Información sobre relaciones', 'Información sobre relaciones', 1, 0, NULL, 7, NULL, NULL, ''),
(2, 0, '770', 'h', 'Descripción fisica', 'Descripción fisica', 0, 0, NULL, 7, NULL, NULL, ''),
...
(2, 0, '770', 'o', 'Otro ítem identificador', 'Otro ítem identificador', 1, 0, NULL, 7, NULL, NULL, ''),
...
(2, 0, '770', 't', 'Título', 'Título', 0, 0, NULL, 7, NULL, NULL, ''),
(0, 0, '770', 'u', 'Standard Technical Report Number', 'Standard Technical Report Number', 0, 0, NULL, -1, NULL, NULL, ''),
(2, 0, '770', 'w', 'Número de Control del Registro', 'Número de Control del Registro', 1, 0, NULL, 7, NULL, NULL, ''),
...
(2, 0, '772', 'b', 'Edición', 'Edición', 0, 0, NULL, 7, NULL, NULL, ''),
(0, 0, '772', 'c', 'Qualifying information', 'Qualifying information', 0, 0, NULL, -1, NULL, NULL, ''),
(2, 0, '772', 'd', 'Lugar, editorial y fecha de publicación', 'Lugar, editorial y fecha de publicación', 0, 0, NULL, 7, NULL, NULL, ''),
(2, 0, '772', 'g', 'Información sobre relaciones', 'Información sobre relaciones', 1, 0, NULL, 7, NULL, NULL, ''),
(2, 0, '772', 'h', 'Descripción fisica', 'Descripción fisica', 0, 0, NULL, 7, NULL, NULL, ''),
...
(2, 0, '772', 'o', 'Otro ítem identificador', 'Otro ítem identificador', 1, 0, NULL, 7, NULL, NULL, ''),
...
(2, 0, '772', 't', 'Título', 'Título', 0, 0, NULL, 7, NULL, NULL, ''),
(0, 0, '772', 'u', 'Standard Technical Report Number', 'Standard Technical Report Number', 0, 0, NULL, -1, NULL, NULL, ''),
(2, 0, '772', 'w', 'Número de Control del Registro', 'Número de Control del Registro', 1, 0, NULL, 7, NULL, NULL, ''),
...
(2, 0, '773', 'b', 'Edición', 'Edición', 0, 0, NULL, 7, NULL, NULL, ''),
(2, 0, '773', 'd', 'Lugar, editorial y fecha de publicación', 'Lugar, editorial y fecha de publicación', 0, 0, NULL, 7, NULL, NULL, ''),
(2, 0, '773', 'g', 'Información sobre relaciones', 'Información sobre relaciones', 1, 0, NULL, 7, NULL, NULL, ''),
(2, 0, '773', 'h', 'Descripción fisica', 'Descripción fisica', 0, 0, NULL, 7, NULL, NULL, ''),
...
(2, 0, '773', 'o', 'Otro ítem identificador', 'Otro ítem identificador', 1, 0, NULL, 7, NULL, NULL, ''),
...
(2, 0, '773', 't', 'Título', 'Título', 0, 0, NULL, 7, NULL, NULL, ''),
(0, 0, '773', 'u', 'Standard Technical Report Number', 'Standard Technical Report Number', 0, 0, NULL, -1, NULL, NULL, ''),
(2, 0, '773', 'w', 'Número de Control del Registro', 'Número de Control del Registro', 1, 0, NULL, 7, NULL, NULL, ''),
...
(2, 0, '774', 'b', 'Edición', 'Edición', 0, 0, NULL, 7, NULL, NULL, ''),
(0, 0, '774', 'c', 'Qualifying information', 'Qualifying information', 0, 0, NULL, -1, NULL, NULL, ''),
(2, 0, '774', 'd', 'Lugar, editorial y fecha de publicación', 'Lugar, editorial y fecha de publicación', 0, 0, NULL, 7, NULL, NULL, ''),
(2, 0, '774', 'g', 'Información sobre relaciones', 'Información sobre relaciones', 1, 0, NULL, 7, NULL, NULL, ''),
(2, 0, '774', 'h', 'Descripción fisica', 'Descripción fisica', 0, 0, NULL, 7, NULL, NULL, ''),
...
(2, 0, '774', 'o', 'Otro ítem identificador', 'Otro ítem identificador', 1, 0, NULL, 7, NULL, NULL, ''),
(0, 0, '774', 'r', 'Report number', 'Report number', 1, 0, NULL, -1, NULL, NULL, ''),
(0, 0, '774', 's', 'Uniform title', 'Uniform title', 0, 0, NULL, -1, NULL, NULL, ''),
(2, 0, '774', 't', 'Título', 'Título', 0, 0, NULL, 7, NULL, NULL, ''),
(0, 0, '774', 'u', 'Standard Technical Report Number', 'Standard Technical Report Number', 0, 0, NULL, -1, NULL, NULL, ''),
(2, 0, '774', 'w', 'Número de Control del Registro', 'Número de Control del Registro', 1, 0, NULL, 7, NULL, NULL, ''),
...
(2, 0, '777', 'b', 'Edición', 'Edición', 0, 0, NULL, 7, NULL, NULL, ''),
(0, 0, '777', 'c', 'Qualifying information', 'Qualifying information', 0, 0, NULL, -1, NULL, NULL, ''),
(2, 0, '777', 'd', 'Lugar, editorial y fecha de publicación', 'Lugar, editorial y fecha de publicación', 0, 0, NULL, 7, NULL, NULL, ''),
(2, 0, '777', 'g', 'Información sobre relaciones', 'Información sobre relaciones', 1, 0, NULL, 7, NULL, NULL, ''),
(2, 0, '777', 'h', 'Descripción fisica', 'Descripción fisica', 0, 0, NULL, 7, NULL, NULL, ''),
...
(2, 0, '777', 'o', 'Otro ítem identificador', 'Otro ítem identificador', 1, 0, NULL, 7, NULL, NULL, ''),
...
(2, 0, '777', 't', 'Título', 'Título', 0, 0, NULL, 7, NULL, NULL, ''),
(2, 0, '777', 'w', 'Número de Control del Registro', 'Número de Control del Registro', 1, 0, NULL, 7, NULL, NULL, ''),
...
(3, 0, '850', 'a', 'Institución que tiene las existencias', 'Institución que tiene las existencias', 1, 0, NULL, 8, NULL, NULL, ''),
...
(0, 0, '852', '2', 'Fuente de clasificación o Esquema de almacenamiento en la estanteria', 'Fuente de clasificación o Esquema de almacenamiento en la estanteria', 0, 0, '', 8, '', '', ''),
(0, 0, '852', '3', 'Materials specified (NR)', 'Materials specified (NR)', 0, 0, '', -1, '', '', ''),
(0, 0, '852', '6', 'Linkage (NR)', 'Linkage (NR)', 0, 0, '', -1, '', '', ''),
(0, 0, '852', '8', '', '', 1, 0, NULL, -1, '', '', ''),
(3, 0, '852', 'a', 'Localización', 'Localización', 0, 0, '', 8, '', '', ''),
(3, 0, '852', 'b', 'Sublocalización o subárea', 'Sublocalización o subárea', 1, 0, '', 8, '', '', ''),
...
(3, 0, '852', 'h', 'Parte de la Clasificación', 'Parte de la Clasificación', 0, 0, 'biblioitems.classification', 8, '', '', ''),
(3, 0, '852', 'i', 'Parte del Item', 'Parte del Item', 1, 0, '', 8, '', '', ''),
(3, 0, '852', 'j', 'Número de control de almacenamiento/estantería', 'Número de control de almacenamiento/estantería', 0, 0, '', 8, '', '', ''),
...
(3, 0, '852', 't', 'Número de copia', 'Número de copia', 0, 0, '', 8, '', '', ''),
(3, 0, '852', 'x', 'Nota no pública', 'Nota no pública', 1, 0, '', 8, '', '', ''),
(3, 0, '852', 'z', 'Nota pública', 'Nota pública', 1, 0, '', 8, '', '', ''),
...
(3, 0, '856', 'x', 'Nota no pública', 'Nota no pública', 1, 0, NULL, 8, NULL, NULL, ''),
(0, 0, '856', 'y', 'Link text (R)', 'Link text (R)', 1, 0, NULL, -1, NULL, NULL, ''),
(3, 0, '856', 'z', 'Nota pública', 'Nota pública', 1, 0, NULL, 8, NULL, NULL, ''),
...
(0, 0, '043', 'b', 'Código Local GAC (R)', 'Código Local GAC (R)', 1, 0, NULL, -1, NULL, NULL, ''),
