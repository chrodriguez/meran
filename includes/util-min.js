...
function scrollTo(idObj){var result_array=$("#"+idObj);if(result_array.length==0)return;var divOffset=$('#'+idObj).offset().top;$('html,body').animate({scrollTop:divOffset},1000);}
...
function replaceNonAccents(s){var r=s.toLowerCase();r=r.replace(new RegExp(/\s/g),"");r=r.replace(new RegExp(/[a]/g),"á");r=r.replace(new RegExp(/[a]/g),"à");r=r.replace(new RegExp(/[e]/g),"é");r=r.replace(new RegExp(/[e]/g),"è");r=r.replace(new RegExp(/[i]/g),"í");r=r.replace(new RegExp(/[i]/g),"ì");r=r.replace(new RegExp(/[o]/g),"ó");r=r.replace(new RegExp(/[o]/g),"ò");r=r.replace(new RegExp(/[u]/g),"ú");r=r.replace(new RegExp(/[u]/g),"ù");r=r.replace(new RegExp(/[n]/g),"ñ");r=r.replace(new RegExp(/æ/g),"ae");r=r.replace(new RegExp(/ç/g),"c");r=r.replace(new RegExp(/[èéêë]/g),"e");r=r.replace(new RegExp(/[ìíîï]/g),"i");r=r.replace(new RegExp(/ñ/g),"n");r=r.replace(new RegExp(/[òóôõö]/g),"o");r=r.replace(new RegExp(/œ/g),"oe");r=r.replace(new RegExp(/[ùúûü]/g),"u");r=r.replace(new RegExp(/[ýÿ]/g),"y");r=r.replace(new RegExp(/\W/g),"");return r;}