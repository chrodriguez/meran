...
shouldScrollUser=doScroll;objAH=new AjaxHelper(updateInfoUsuarios);objAH.showOverlay=true;objAH.cache=true;busqueda=jQuery.trim($('#socio-bar').val());inicial='0';if(jQuery.trim(busqueda).length>0){objAH.url='/cgi-bin/koha/usuarios/reales/buscarUsuarioResult.pl';objAH.showOverlay=true;objAH.debug=true;objAH.funcion='changePage';objAH.socio=busqueda;objAH.sendToServer();}
