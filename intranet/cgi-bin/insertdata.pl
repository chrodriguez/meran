...
if (my $data2=$sth->fetchrow_hashref){
  ...
  documenttype = '$data{'documenttype'}',documentnumber='$data{'documentnumber'}',changepassword='$data{'updatepassword'}',
  studentnumber='$data{studentnumber}'
  where borrowernumber='$data{'borrowernumber'}'";

#inserta initials='$data{'initials'} que en ningun memnto se pasa como parametro, ver si se saca'
...
if (my $data2=$sth->fetchrow_hashref){
 ...
 studentnumber='$data{studentnumber}' 
where personnumber='$data2->{'personnumber'}'";
...
my $sth2=$dbh->prepare($query);
  ...
  initials,ethnicity,physstreet,branchcode,zipcode,homezipcode,documenttype,documentnumber,lastchangepassword,changepassword,studentnumber)  values ('$data{'title'}','$data{'expiry'}','$data{'cardnumber'}',
  ...
  '$data{'documenttype'}','$data{'documentnumber'}',NULL,'$data{'updatepassword'}','$data{'studentnumber'}')";
