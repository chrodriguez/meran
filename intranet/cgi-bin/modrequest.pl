...
for (my $i=0;$i<$count;$i++){
   # UpdateReserve($rank[$i],$biblio[$i],$borrower[$i],$branch[$i]); #from C4::Reserves	 
    UpdateGroupReserve($rank[$i],$biblio[$i],$borrower[$i],$branch[$i] ,$biblioitemnumber[$i],$timestamp[$i] ); #from C4::Reserves2
