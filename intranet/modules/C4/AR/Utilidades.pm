...
my @VALUES_COMPONENTS = (   "-1", "text", "texta", "combo", "auto", "calendar", "anio", "anio_rango" );
my %LABELS_COMPONENTS = (   "-1" => "SIN SELECCIONAR" => "text" => "Texto" , "texta" => "Texto Area", "combo" => "ComoBox", 
                            "auto" => "Autocompletable", "calendar" => "Calendario", "anio" => "A&ntilde;o", "anio_rango" => "A&ntilde;o Rango" );
