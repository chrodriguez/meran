...
Epoch.prototype.calConfig = function () //PRIVATE: initialize calendar variables
{
	...
	this.rangeYearLower = 1990;
	this.rangeYearUpper = 2020;
...
{
	this.daylist = new Array('Do','Lu','Ma','Mi','Ju','Vi','Sa','Do','Lu','Ma','Mi','Ju','Vi','Sa'); /*<lang:en>*/
	this.months_sh = new Array('Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre');
	this.monthup_title = 'Ir al siguiente mes';
	this.monthdn_title = 'Ir al mes anterior';
	this.clearbtn_caption = 'Cerrar';
	this.clearbtn_title = 'Cerrar';
	this.maxrange_caption = 'Este es el rango m&aacute;ximo';
};
//-----------------------------------------------------------------------------
