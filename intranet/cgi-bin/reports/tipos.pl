...
my ($template, $loggedinuser, $cookie)
    = get_template_and_user({template_name => "reports/tipos.tmpl",
			     query => $input,
			     type => "intranet",
			     authnotrequired => 0,
...
#FIN inicializacion
No necesito ni paginas ni orden puesto que son pocos tipos
=cut

my @resultsdata= cantidadTipos();#Cantidad de biblioitems por cada tipo
#my $cantidad=cantidadPrestamos($branch);#Cantidad total de prestamos para calcular la cantidad de paginas
