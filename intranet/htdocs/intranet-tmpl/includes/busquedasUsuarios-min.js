...
shouldScrollUser=doScroll;objAH=new AjaxHelper(updateInfoUsuarios);objAH.showOverlay=true;objAH.cache=true;busqueda=jQuery.trim($('#socio-bar').val());inicial='0';if(filtro){inicial=filtro;busqueda=jQuery.trim(filtro);objAH.inicial=inicial;$('#socio').val(FILTRO_POR+filtro);}
else
