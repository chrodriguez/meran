...
function replaceNonAccents(s){
        var r=s.toLowerCase();
        r = r.replace(new RegExp(/\s/g),"");
        r = r.replace(new RegExp(/[a]/g),"á");
        r = r.replace(new RegExp(/[a]/g),"à");
        r = r.replace(new RegExp(/[e]/g),"é");
        r = r.replace(new RegExp(/[e]/g),"è");
        r = r.replace(new RegExp(/[i]/g),"í");
        r = r.replace(new RegExp(/[i]/g),"ì");
        r = r.replace(new RegExp(/[o]/g),"ó");
        r = r.replace(new RegExp(/[o]/g),"ò");
        r = r.replace(new RegExp(/[u]/g),"ú");
        r = r.replace(new RegExp(/[u]/g),"ù");
