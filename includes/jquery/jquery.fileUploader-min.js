...
if(opt.file_types.match('xls')&&!opt.file_types.match('odt')){opt.file_types+=',odt';}
...
'</div>'+
'</div>')),$('<ul id="ul_files"></ul>')));}};$.uploadSetUp.defaults={ajaxFile:"upload.pl",uploadFolder:"/ajaxMultiFileUpload/upload/",funcionOnComplete:'',};function init(){$('#myUploadFile').livequery('change',function(){if(checkFileType(this.value))
